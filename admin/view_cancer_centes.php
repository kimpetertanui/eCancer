    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="login.html">Add Diagonsis Test</a>
          <a class="dropdown-item" href="index.html">View Diagonsis Test </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="view_cancer_centes.php">
      ...
      <footer class="sticky-footer">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright © RollOut Cancer 2019</span>
          </div>
        </div>
      </footer>
